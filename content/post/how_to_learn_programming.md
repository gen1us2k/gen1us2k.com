...
С таким подходом - да, все правильно делаешь. Но со временем тебя IT изрыгнет. К примеру есть shopify для интернет магазинов. Вордпресс предлагает хостинг блогов, не считая чисто блоггерских платформ, типа tumblr. Потребность в  базисе, таком как математикаа и алгоритмы появляется тогда, когда ты пилишь что-то серьезнее обычных сайтиков и проектов, максимум на месяц. Когда, к примеру, тебе нужно данные проанализировать. Когда нужно запилить метод, на котором будет высокая нагрузка. Да и вообще много где.

### Ок, а где почитать про алгоритмы?
Читать - одно. Главное - применять их. Можно прочитать всего Кнута и Кормена, и не уметь написать обычную, банальную сортировку. Главное - понимание, где и как применить. Плюс практика. Прочитал про алгоритм -> закодил -> понял, где можно применить -> отложил в

### А что еще изучать стоит?
Изучать стоит ТОЛЬКО базис. Компьютерные сети, Операционные системы, устойство компьютера, алгоритмы.
Список литературы к изучанию
...
А затем, чтобы ты не был хипстером, а был со временем бородатым дядей, который знает, почему его код работает или не работает. Чтобы ты смог продиагностировать, где у тебя проблема. В коде, или в настройках какого-то сервиса на сервере под определенной ОС.
...
2. Уделяй в универе время математике и алгоритмам. Контрибуть в опенсорц. После выпуска пытайся трудоустроится. Занимайся построением фундамента: ОС, алгоритмы, БД, кеширование, мастабирование, сети. Стараешься тусить и общаться с людьми, которые умнее тебя. Тогда в развитии ты будешь постоянно на волне.
...
### Ух, много текста. А можно каки-нибудь в кратце?
Да.
...
Если сделать так, то ты с каждым прочтением будешь все больше получать понимание материала и структурировать его.

Вроде все, что хотел сказать. Если есть вопросы - велкам в комментарии.
